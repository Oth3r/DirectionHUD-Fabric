...
//                                .description((OptionDescription) CUtl.tLang("config.max_xz.info"))
//                                .binding(config.defaults.MAXxz, () -> config.MAXxz, n -> config.MAXxz = (int) n)
//                                .controller(IntegerFieldControllerBuilder.create()
//                                .build())
//                        .option(Option.createBuilder()
//                                .name(CUtl.tLang("config.max_y"))
//                                .description((OptionDescription) CUtl.tLang("config.max_y.info"))
//                                .binding(config.defaults.MAXy, () -> config.MAXy, n -> config.MAXy = (int) n)
